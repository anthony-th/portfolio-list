...
function ResumeButtonAbout() {
  return (
    <a
      ...
      className={
        "font-yesteryear bg-transparent text-2xl py-0 px-2 hover:bg-[#ffffff] group transition-colors duration-500  rounded border hover:border-white min-w-[116px] min-h-[36px] pt-[0.07em] relative bottom-3 border-t-0"
      }
      target={"_blank"}
